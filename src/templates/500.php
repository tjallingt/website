...
<html>
	...
	<body>
		...
		<article class="vertical-padding row center">
			<h2>500</h2>
			<p>
				There seems to be a problem with the server...<br>
				If this problem persists please <a href="/maillink?subject=500%20error" target="_blank">contact the site administrator</a>.
			</p>
		</article>
	</body>
</html>